#!/usr/bin/env python3
"""
Stage 2: Generate Videos from Images + Add Classical Music
Reads generated images from Stage 1 and video prompts, then generates videos using LTX2.
Adds soothing classical music background for kids.

Usage:
    python 02_generate_videos.py <story_name>
    python 02_generate_videos.py lumi_bunny
    python 02_generate_videos.py lumi_bunny --no-music
...
class VideoGenerator:
    ...
    def queue_video(self, image_filename: str, prompt: str, scene_number: int, output_prefix: str) -> str:
        """Queue a single video generation."""
        ...
        workflow = {
            ...
            "4": {
                "inputs": {
                    "text": "blurry, low quality, still frame, watermark, overlay, titles",
                    "clip": ["2", 0]
                },
                "class_type": "CLIPTextEncode"
            },
            ...
            "7": {
                "inputs": {
                    ...
                    "width": 1920,
                    "height": 1088,
                    "length": 481,  # 481 frames = ~19 seconds at 25fps (must be divisible by 8+1)
                    "batch_size": 1,
                    "strength": 1.0
                },
            ...
            "16": {
                "inputs": {
                    "video": ["15", 0],
                    "filename_prefix": f"video/{output_prefix}_scene_{scene_number:03d}",
                    "format": "mp4",
                    "codec": "h264"
                },
...
def main():
    ...
    print("\n" + "="*70)
    print("  🎬 Stage 2: Video Generation (LTX2 Image-to-Video)")
    print("="*70 + "\n")
